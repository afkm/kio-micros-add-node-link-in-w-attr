...
require('seneca')()
  ...
  .add('cmd:addNode,cuid:*,nodeType:*,nodeTitle:*,nodeAttributes:*,linkIn:*,linkType:*,linkProps:*', function(message, done) {
    var properties = "";
    ...
    queryString += "MATCH (a { cuid: '" + message.cuid + "' }), (b { cuid: '" + message.linkIn + "'}) MERGE (a)<-[:" + message.linkType + " { " + linkProps + " }]-(b)\n";
  ...
  .listen({
    type: 'amqp',
    pin: 'cmd:addNode,cuid:*,nodeType:*,nodeTitle:*,nodeAttributes:*,linkIn:*,linkType:*,linkProps:*',
